...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask|ControlMask, XK_F1,     tagall,         {.v = "F1" } },
	{ MODKEY|ShiftMask|ControlMask, XK_F2,     tagall,         {.v = "F2" } },
	{ MODKEY|ShiftMask|ControlMask, XK_F3,     tagall,         {.v = "F3" } },
	{ MODKEY|ShiftMask|ControlMask, XK_F4,     tagall,         {.v = "F4" } },
	{ MODKEY|ShiftMask|ControlMask, XK_F5,     tagall,         {.v = "F5" } },
	{ MODKEY|ShiftMask|ControlMask, XK_F6,     tagall,         {.v = "F6" } },
	{ MODKEY|ShiftMask|ControlMask, XK_F7,     tagall,         {.v = "F7" } },
	{ MODKEY|ShiftMask|ControlMask, XK_F8,     tagall,         {.v = "F8" } },
	{ MODKEY|ShiftMask|ControlMask, XK_F9,     tagall,         {.v = "F9" } },
